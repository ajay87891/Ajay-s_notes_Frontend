...
function AddNoteCard(props) {
  ...
  return (
    ...
    <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">ADD NEW NOTE</h5>
    <span>
        <img src={plusLight} alt="Add" className='dark:hidden' />
        <img src={plusDark} alt="Add" className='hidden dark:block'/>
    </span>
</button>
